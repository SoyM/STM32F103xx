...
void Flash_Read(void)
{
	...
	{		
	PA=(float)PID_Parameter[0]/100;
	PB=(float)PID_Parameter[1]/100;
	PC=(float)PID_Parameter[2]/100;
	PD=(float)PID_Parameter[3]/100;
	}
}	

void Flash_Write(void)
{
Flash_Parameter[0]=PA*100;		
Flash_Parameter[1]=PB*100;	
Flash_Parameter[2]=PC*100;	
Flash_Parameter[3]=PD*100;	
